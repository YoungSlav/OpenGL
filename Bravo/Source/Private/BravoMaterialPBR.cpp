...
void BravoMaterialPBR::Use()
{
	...
	ShaderAsset->SetBool("material.useAlbedoTexture", AlbedoTexture != nullptr);
	ShaderAsset->SetBool("material.useMetallicTexture", MetallicTexture != nullptr);
	ShaderAsset->SetBool("material.useRoughnessTexture", RoughnessTexture != nullptr);
	ShaderAsset->SetBool("material.useAoTexture", AoTexture != nullptr);
	ShaderAsset->SetBool("material.useNormalTexture", NormalTexture != nullptr);
